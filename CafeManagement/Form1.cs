    ...
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
           ...
           // rtfReceipt.AppendText(Environment.NewLine);
            rtfReceipt.AppendText("-------------------------------------------------------------" + Environment.NewLine);
            rtfReceipt.AppendText("\t\t" + "Cafe de Italiano" + Environment.NewLine);
            rtfReceipt.AppendText("-------------------------------------------------------------" + Environment.NewLine);
        ...
        { //btnTotal
            ...
            lblDrinkCost.Text = String.Format(new CultureInfo("cs-CZ"),"{0:C}", drinkCosts);
            lblCakeCost.Text = String.Format(new CultureInfo("cs-CZ"), "{0:C}", cakeCosts);
            lblSvcCharge.Text = String.Format(new CultureInfo("cs-CZ"), "{0:C}", svcCharge);
            lblSubTotal.Text = String.Format(new CultureInfo("cs-CZ"), "{0:C}", (cakeCosts + drinkCosts + svcCharge));
            lblTax.Text = String.Format(new CultureInfo("cs-CZ"), "{0:C}", totalAftTax);
            lblTotal.Text = String.Format(new CultureInfo("cs-CZ"), "{0:C}", (cakeCosts + drinkCosts + svcCharge + totalAftTax));
        }
